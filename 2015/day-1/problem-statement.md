...
a little confusing. He starts on the ground floor (floor 0) and 
...
## Second part
```
Now, given the same instructions, find the position of 
the first character that causes him to enter the basement (floor -1).
